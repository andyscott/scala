...
trait ScalaSettings extends AbsScalaSettings
  ...
  val Ysysdef: StringSetting =
                        StringSetting     ("-Ysysdef", "imports", "Supply a list of packages/objects to be imported into the global scope as system imports", "java.lang._, scala._")
  .withPostSetHook(postSetExclusive(noimports, nopredef))
  val Ypredef: StringSetting =
                        StringSetting     ("-Ypredef", "imports", "Supply a list of packages/objects to be imported into the global scope as predefs", "scala.Predef._")
  .withPostSetHook(postSetExclusive(noimports, nopredef))
